...
;// CONCATENATED MODULE: ./src/components/CSS/movements.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ var movements_module = ({"wholeCat":"ClMuuM3GnnhhlMpoHYLNCQ==","invisible":"_9JHn2qokepfEGUb8ddoMkw==","dimentions":"YLK8OJZm6EQcUYfk-d88oA==","tail":"A9A2nUiHXcauQ8zWbFWoPA==","tailTip":"K8Dhy7a67OpXiesaxXg4Pg==","legs":"_131ToLNY13FALxKiRMZLUg==","arm":"QwknSOGt7cooD+QZcKCxBg==","button":"FEfO6vp-fxIUo+c4EgP4+A==","bodyAndBackLeg":"SuUwFTMP++dzBNuUuWWQVQ==","stomach":"X3+mzOc38I+P28WijykCrQ==","mouth":"Gk1X1rrh9AhFbfUkVg1WTA==","teathColor":"GcySoT4qLtpE43sq9Tj7Ug==","pupil":"g1yDWKuwwnHmIf4ut-NJ4A==","nose":"_5mGM96figF5-WsBq5mUzLA=="});
...
var Sidebar = function Sidebar() {
  var dispatch = useDispatch(); //FOR ROTATION of +20deg

  var _useState = (0,react.useState)(15),
      _useState2 = _slicedToArray(_useState, 2),
      degreeMoved = _useState2[0],
      setDegreeMoved = _useState2[1];

  var onCssChangeHandler = function onCssChangeHandler() {
  ...
  var _useState3 = (0,react.useState)(-15),
      ...
      antiDegreeMoved = _useState4[0],
      setAntiDegreeMoved = _useState4[1];

  var onAntiDegreeMovedHandler = function onAntiDegreeMovedHandler() {
  ...
  var _useState5 = (0,react.useState)(1),
      ...
      stepsMoved = _useState6[0],
      setStepsMoved = _useState6[1];

  var _useState7 = (0,react.useState)(0),
      _useState8 = _slicedToArray(_useState7, 2),
      stepMovedY = _useState8[0],
      setStepMovedY = _useState8[1];

  var onMove10StepsHandler = function onMove10StepsHandler() {
  ...
  var onXValueHandler = function onXValueHandler(event) {
    event.preventDefault();
    var xValue1 = event.target.value;
    setXv(xValue1);
    console.log(event.target.value);
    console.log(xv);
  };

  var onYValueHandler = function onYValueHandler(event) {
    event.preventDefault();
    setYv(event.target.value);
    console.log(yv);
  };

  var onSendToCoordinateHandler = function onSendToCoordinateHandler(event) {
    event.preventDefault();
  ...
  var onMoveToRandom = function onMoveToRandom() {
    var t = document.getElementById("secondx").value;
  };

  var onHelloTimeSubmitHandler = function onHelloTimeSubmitHandler(event) {
    event.preventDefault();
    var tme = document.getElementById("timeHello").value;
    dispatch({
      type: "hello",
      value: true
    });
  ...
  var onHelloSubmitHandler = function onHelloSubmitHandler(event) {
    event.preventDefault();
    dispatch({
      type: "hello",
      value: true
  ...
  var onHmmTimeSubmitHandler = function onHmmTimeSubmitHandler(event) {
    event.preventDefault();
    var tme = document.getElementById("timeHmm").value;
    dispatch({
      type: "hello",
      value: false
    });
  ...
  var onHmmSubmitHandler = function onHmmSubmitHandler(event) {
    event.preventDefault();
    dispatch({
      type: "hello",
      value: false
  ...
  var onSizeChangeHandler = function onSizeChangeHandler(event) {
    event.preventDefault();
    var oasize = document.getElementById("sizehw").value;
    var toBeSendSize = parseFloat(oasize) + 95.17898101806641;
    console.log(toBeSendSize);
    document.documentElement.style.setProperty('--newIncreasedSize', toBeSendSize + "px");
  };

  var onSizePercentageChangeHandler = function onSizePercentageChangeHandler(event) {
    event.preventDefault();
    var sizeValue = document.getElementById("sizehwInPercent").value;
    var changesSize = 95.17898101806641 + parseFloat(sizeValue) / 100 * 95.17898101806641;
    console.log(changesSize);
    document.documentElement.style.setProperty('--newIncreasedSize', changesSize + "px");
  };

  var onTailColorChangeHandler = function onTailColorChangeHandler(event) {
    event.preventDefault();
    var tailColor = document.getElementById("tailColor").value;
    document.documentElement.style.setProperty('--tailColor', tailColor);
  };

  var onTailTipColorChangeHandler = function onTailTipColorChangeHandler(event) {
    event.preventDefault();
    var tailtipcolor = document.getElementById("tailTipColor").value;
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    onClick: onMove10StepsHandler
  }, "Move 10 steps"), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: onAntiDegreeMovedHandler
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-white px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: onCssChangeHandler
  }, "Turn ", /*#__PURE__*/react.createElement(Icon, {
    name: "redo",
    size: 15,
    className: "text-white mx-2"
  }), "15 degrees"), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Go to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: onSendToCoordinateHandler
    ...
    size: "1",
    id: "piny",
    onChange: onYValueHandler
  }), /*#__PURE__*/react.createElement("button", {
    className: movements_module.button
  }, "Click"))), /*#__PURE__*/react.createElement("div", {
    className: "font-bold"
  }, " ", "Looks", " "), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Say `Hello` for ", "\xA0", /*#__PURE__*/react.createElement("form", {
    onSubmit: onHelloTimeSubmitHandler
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: onHelloSubmitHandler
  }, "Say Hello "), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Think Hmm for ", "\xA0", /*#__PURE__*/react.createElement("form", {
    onSubmit: onHmmTimeSubmitHandler
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    size: "1",
    id: "timeHmm"
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer",
    onClick: onHmmSubmitHandler
  }, "Think Hmm "), /*#__PURE__*/react.createElement("div", {
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change size by ", /*#__PURE__*/react.createElement("form", {
    onSubmit: onSizeChangeHandler
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    size: "1",
    id: "sizehw"
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Set size to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: onSizePercentageChangeHandler
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    size: "1",
    id: "sizehwInPercent"
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change tail color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: onTailColorChangeHandler
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    size: "1",
    id: "tailColor"
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change tail tip color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: onTailTipColorChangeHandler
  }, /*#__PURE__*/react.createElement("input", {
    type: "text",
    size: "1",
    id: "tailTipColor"
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change back leg color to ", /*#__PURE__*/react.createElement("form", {
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change arm color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var armcolor = document.getElementById("armColor").value;
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change body color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change stomach color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var stomachcolor = document.getElementById("stomachColor").value;
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change mouth color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var mouthcolor = document.getElementById("mouthColor").value;
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change teath color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var teathcolor = document.getElementById("teathColor").value;
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change pupil color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var pupilcolor = document.getElementById("pupilColor").value;
    ...
    className: "flex flex-row flex-wrap bg-blue-500 text-black px-2 py-1 my-2 text-sm cursor-pointer"
  }, "Change nose color to ", /*#__PURE__*/react.createElement("form", {
    onSubmit: function onSubmit(event) {
      event.preventDefault();
      var nosecolor = document.getElementById("noseColor").value;
...
function CatSprite() {
  var _useSelector = useSelector(function (state) {
    return state;
      ...
      hello = _useSelector.hello,
      hmm = _useSelector.hmm;

  console.log(hello, " ", hmm);
  return /*#__PURE__*/react.createElement("div", {
    className: movements_module.wholeCat
  }, hello ? /*#__PURE__*/react.createElement("svg", {
    height: "30",
    width: "200",
    class: movements_module.invisible
    ...
    y: "15",
    fill: "red"
  }, "Hmm")), /*#__PURE__*/react.createElement("svg", {
    ...
    version: "1.1",
    xmlSpace: "preserve",
    className: movements_module.dimentions
    ...
    className: movements_module.tail
  }), /*#__PURE__*/react.createElement("path", {
    ...
    fill: "#FFFFF",
    strokeWidth: "1",
    className: movements_module.tailTip
  })), /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.legs
  }), /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.arm
  }), /*#__PURE__*/react.createElement("g", {
    id: "body-and-leg"
  }, /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.bodyAndBackLeg
  }), /*#__PURE__*/react.createElement("path", {
    ...
    fill: "#FFFFFF",
    strokeWidth: "1",
    className: movements_module.stomach
  })), /*#__PURE__*/react.createElement("path", {
    ...
    fill: "#FFFFFF",
    strokeWidth: "1",
    className: movements_module.mouth
  }), /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.teathColor
  }), /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.nose
  }), /*#__PURE__*/react.createElement("path", {
    ...
    strokeLinecap: "round",
    strokeLinejoin: "round",
    className: movements_module.pupil
  }), /*#__PURE__*/react.createElement("path", {
...
function PreviewArea() {
  return /*#__PURE__*/react.createElement("div", {
    className: "flex-none h-full overflow-y p-8 "
...
function App() {
  ...
  }, /*#__PURE__*/react.createElement(components_Sidebar, null), " ", /*#__PURE__*/react.createElement(MidArea, null)), /*#__PURE__*/react.createElement("div", {
...
var crudReducer = function crudReducer() {
  ...
  if (action.type == "hello") {
    return crud_store_objectSpread(crud_store_objectSpread({}, state), {}, {
      hello: action.value
    });
  }
...
var curdStore = createStore(crudReducer);
/* harmony default export */ var crud_store = (curdStore);
...
root.render( /*#__PURE__*/react.createElement(components_Provider, {
  store: crud_store
}, /*#__PURE__*/react.createElement(App, null))); // import React from "react";
